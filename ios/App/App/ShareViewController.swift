...
class ShareViewController: UIViewController {
    ...
    private func sendData() {
        ...
        var urlComps = URLComponents(string: "bharatonline://shared-content")!
    ...
    fileprivate func createSharedFileUrl(_ url: URL?) -> String {
        ...
        let copyFileUrl =
        fileManager.containerURL(forSecurityApplicationGroupIdentifier: "group.com.bharatonline.customer.app.widget")!
